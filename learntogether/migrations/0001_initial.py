...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'learntogether_collabsession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learntogether.Course'])),
            ...
            ('repeats_in_days', self.gf('django.db.models.fields.IntegerField')(default=7)),
        ))
        ...
        db.create_table(u'learntogether_usergamepoint', (
            ...
            ('collab_session_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learntogether.CollabSessionEvent'], null=True, blank=True)),
        ))
        ...
        db.create_table(u'learntogether_collabsessionevent', (
            ...
            ('session_date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('leader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learntogether.User'], null=True, blank=True)),
        ))
